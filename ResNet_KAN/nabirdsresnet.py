...
resnet50.fc = KAN([num_features, len(class_names)])
resnet50.to(device)
optimizer = optim.AdamW(resnet50.parameters(), lr=8e-4, weight_decay=1e-4)
scheduler = optim.lr_scheduler.ExponentialLR(optimizer, gamma=0.8)

resnet50 = torch.load("nabirdsres50.pt")
...
for epoch in range(10):
    ...
    scheduler.step()
    torch.save(resnet50, "nabirdsres50.pt")
    print(
